...
SOURCEFILES_QUOTED_IF_SPACED=Principal.s Principal4.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Principal.o ${OBJECTDIR}/Principal4.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Principal.o.d ${OBJECTDIR}/Principal4.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Principal.o ${OBJECTDIR}/Principal4.o

# Source Files
SOURCEFILES=Principal.s Principal4.s
...
${OBJECTDIR}/Principal4.o: Principal4.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Principal4.o 
	${MP_AS} -mcpu=PIC16F84 -c \
	-o ${OBJECTDIR}/Principal4.o \
	Principal4.s \
	 -misa=std -msummary=+mem,-psect,-class,-hex,-file,-sha1,-sha256,-xml,-xmlfull -fmax-errors=20 -mwarn=0 -xassembler-with-cpp
...
dist/${CND_CONF}/${IMAGE_TYPE}/Proyecto_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_LD} -mcpu=PIC16F84 ${OBJECTFILES_QUOTED_IF_SPACED} \
